...
graph TD
    ...
    MODE --> D1["📝 По описанию"]
    MODE --> D2["🎤 Свой текст"]
    MODE --> D3["🎹 Инструментал"]
    
    D1 --> GENDER["🚹/🚺 Голос"]
    D2 --> LYRICS["Ввод лирики"] --> GENDER
    D3 --> STYLE["Выбор стиля"]
    GENDER --> STYLE
    
    STYLE --> GEN["⚡ Генерация 1-3 мин"]
    GEN --> RES["🔊 2 voice-превью"]
    
    RES --> DL["📥 Скачать MP3 (−1💎)"]
    RES --> REGEN["🔄 Ещё (−1💎)"]
    RES --> MENU
```
